...
if page == "🔍 About Us":
    ...
    - **Wong Joon Ee** - Data Scientist: With expertise in machine learning and statistical analysis, Wong leads the development of our predictive models.
    - **Wong Joon Ee** - Real Estate Expert: Wong's deep understanding of the real estate market helps us tailor our models to real-world conditions.
    - **Wong Joon Ee** - Software Engineer: Wong ensures that our tools are user-friendly and technically robust, providing seamless experiences for our users.
    - **Wong Joon Ee** - UI/UX Designer: Wong designs our interfaces to be intuitive and engaging, focusing on delivering a great user experience.
